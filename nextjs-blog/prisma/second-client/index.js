...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/nurul/Documents/prisma-cases/prisma-deno-deploy/Prisma-React-Select/nextjs-blog/prisma/second-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "second-client/libquery_engine-darwin.dylib.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "second-client/schema.prisma")
